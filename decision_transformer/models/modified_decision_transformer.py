...
class ModifiedDecisionTransformer(TrajectoryModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.embed_rs = torch.nn.Linear(1 + self.state_dim, hidden_size)
    ...
    def forward(
        ...
        rs_embeddings = self.embed_rs(
            torch.cat([returns_to_go, states], dim=-1)
        )
        action_embeddings = self.embed_action(actions)
        time_embeddings = self.embed_timestep(timesteps)

        # time embeddings are treated similar to positional embeddings
        rs_embeddings = rs_embeddings + time_embeddings
        ...
        return rs_preds, action_preds, None
