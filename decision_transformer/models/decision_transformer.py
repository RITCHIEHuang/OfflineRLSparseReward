...
class DecisionTransformer(TrajectoryModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.embed_sar = torch.nn.Linear(
            self.state_dim + self.act_dim + 1, hidden_size
        )
    ...
    def forward(
        ...
        sar_embeddings = self.embed_sar(
            torch.cat([states, actions, returns_to_go], dim=-1)
        )
        ...
        sar_embeddings = sar_embeddings + time_embeddings
